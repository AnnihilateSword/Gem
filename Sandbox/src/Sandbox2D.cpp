...
void Sandbox2D::OnUpdate(Gem::Timestep ts)
{
...

	{
		...
		Gem::Renderer2D::DrawRotatedQuad({ -1.0f, 0.0f }, { 0.8f, 0.8f }, glm::radians(60.0f), { 0.8f, 0.2f, 0.3f, 1.0f });
		Gem::Renderer2D::DrawQuad({ 0.5f, -0.5f }, { 0.5f, 0.75f }, { 0.2f, 0.3f, 0.8f, 1.0f });
		// z = -0.1f (need enable depth test)
		Gem::Renderer2D::DrawQuad({ 0.0f, 0.0f, -0.1f }, { 10.0f, 10.0f }, m_CheckerboardTexture, 10.0f, { 1.0f, 0.9f, 0.9f, 1.0f });
